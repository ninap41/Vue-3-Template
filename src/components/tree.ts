					...
					children: [
						{
							...
							label: 'Expenses', ext: '.doc', data: 'Expenses Document'
						},
						{
							key: '0-0-1-2', absolutePath: 'Root/Documents/Work/Resume/',
							label: 'Resume', ext: '.doc', data: 'Resume Document'
						}
					]
				},
				{
					...
					ext: '/',
					data: 'Folder',
					executable: (command: string) => { if (command === "open") return "open" },
